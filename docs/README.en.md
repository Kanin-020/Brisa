...
## How to add a new port (in 5 minutes)
...
To distribute updatable manifests:
...
| Port | Game | Repo | Required ROM |
|---|---|---|---|
| `soh` | Ocarina of Time | `HarbourMasters/Shipwright` | OoT NTSC 1.0 (`.z64`/`.n64`) + Master Quest (optional) |
